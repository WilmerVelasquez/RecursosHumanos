    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdUsuario = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NDocumento = table.Column<int>(type: "int", nullable: true),
                    ...
                    Correo = table.Column<string>(type: "nvarchar(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Usuario_Horario_HorarioIdHorario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroIngreso", x => x.IdRegistro);
                    table.ForeignKey(
                        name: "FK_RegistroIngreso_Horario_IdHorarioNavigationIdHorario",
                        column: x => x.IdHorarioNavigationIdHorario,
                        principalTable: "Horario",
                        principalColumn: "IdHorario",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegistroIngreso_Usuario_IdUsuarioNavigationIdUsuario",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroIngreso_IdHorarioNavigationIdHorario",
                table: "RegistroIngreso",
                column: "IdHorarioNavigationIdHorario");

            migrationBuilder.CreateIndex(
                name: "IX_RegistroIngreso_IdUsuarioNavigationIdUsuario",
                table: "RegistroIngreso",
                column: "IdUsuarioNavigationIdUsuario");

            migrationBuilder.CreateIndex(
                name: "IX_Usuario_HorarioIdHorario",
                table: "Usuario",
